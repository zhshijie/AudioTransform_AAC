...
//  AudioTransform
//
//  Created by WillToSky on 16/9/24.
...
- (void)transcode {
    ...
    NSString *AACFileName = @"月光の云海 - 久石譲.aac";
    NSString *inputName = @"月光の云海 - 久石譲.mp3";
...
- (void)convertMP3ToAAC {
    ...
    NSString *aacFileName = @"月光の云海 - 久石譲.aac";
    NSString *pcmFileName = @"月光の云海 - 久石譲.pcm";
    ...
    NSString *inputFileName = [bundle stringByAppendingPathComponent:@"月光の云海 - 久石譲.mp3"];
